"""Expanding-window walk-forward validation splits. Never a random split across game rows --
every fold's training set is strictly earlier seasons than its validation season. Ported
near-verbatim from the sibling cfb_win_total_model project's modeling/splits.py -- this logic
is target-agnostic (season-boundary bookkeeping only)."""
